...
function checkForPreCompiled() {
    ...
    if (process.versions.electron) {
        ...
        const preCompiledPath = path.resolve(path.join(__dirname, './native/', process.platform, process.arch, version, (process.env.EDGE_USE_CORECLR ? 'edge_coreclr' : 'edge_nativeclr')));
